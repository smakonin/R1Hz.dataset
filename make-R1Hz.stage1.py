...
cur.execute('CREATE TABLE meta ( unix_ts integer PRIMARY KEY NOT NULL, local_date char(10) NOT NULL, local_time char(8) NOT NULL, imputed char(1) NOT NULL, voltage_l1 real, voltage_l2 real, freq real );')
